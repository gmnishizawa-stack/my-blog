...
date = "2026-04-16"
summary = "インターネットのセキュリティを語るとき、「ボット」という言葉はしばしば悪者扱いされます。でも、実際はそうとは限りません。ボットを一概に遮断すればいいのではなく、根本的には攻撃である場合を遮断するのが適切な対処です。"
+++

## 「ボット＝悪者」という誤解

インターネットのセキュリティを語るとき、「ボット」という言葉はしばしば悪者扱いされます。
でも、実際はそうとは限りません。

ボットとは何かというと、単純には「人間以外」を指します。
...
## Super Bot Fight Modeだけは少し違う

ここで正直に触れておきたいのが、**Super Bot Fight Mode**の存在です。
...
これは、現実社会と同じ考え方です。車を運転していても、信号を守れば問題ない。車という「属性」ではなく、「行い」が問われます。
