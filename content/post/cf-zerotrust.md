...
「城壁の中なら安全」という前提が、もう成り立たなくなったのです。
...
VPNのように「ネットワーク全体にアクセス」ではなく、**「必要なアプリだけにアクセス」**という考え方です。
...
## 1. Cloudflare Access - アプリケーションへの安全な扉

**何ができる？**

社内アプリケーションやツールへのアクセスを保護する機能です。
